...
final appRouter = GoRouter(
  ...
  routes: [
    ...
    GoRoute(path: '/suspended', builder: (context, state) => const SuspendedAccountScreen()),
    ShellRoute(
      ...
      routes: [
        ...
        GoRoute(path: '/customer/providers/:id', builder: (context, state) => ProviderProfileScreen(providerId: state.pathParameters['id']!)),
        GoRoute(path: '/customer/profile', builder: (context, state) => const CustomerProfileScreen()),
        GoRoute(path: '/provider/apply', builder: (context, state) => const BecomeProviderScreen()),
        GoRoute(path: '/provider/verification', builder: (context, state) => const VerificationStatusScreen()),
        ...
        GoRoute(path: '/provider/profile', builder: (context, state) => const ProviderProfileModeScreen()),
      ],
    ),
  ],
);
